...
(define (int_to_bool_h n L)
  (cond
    ...
    [(equal? (remainder n 2) 1) (int_to_bool_h (quotient n 2) (cons #t L))]
    )
...
(define (pad num_bits bit_list)
  (if (equal? num_bits (length bit_list) )
      bit_list
...
(define (demorgan_verify bool_vars)
  (let (;Start of name list
        (a (list-ref bool_vars 0));Pairs (name value)
...
(define (absorp_verify bool_vars)
  (let (;Start of name list
        (x (list-ref bool_vars 0));Pairs (name value)
