#lang racket
; Afridi Karim (akk63) Section 001
#|
...
(define (binplus a b)
  (cond
    [(binzero? a) b]
    [(binzero? b) a]
    [(and (double-plus1? a) (double-plus1? b)) (inc(double-plus1 (binplus (op a) (op b))))]
    [(and (double? a) (double? b)) (double(binplus (op a) (op b)))]
    [(and (double? a) (double-plus1? b)) (double-plus1(binplus (op a) (op b)))]
...
(define (binmult a b)
  (cond
    ...
    [(binone? a) b]
    [(binone? b) a]
    [(and (double-plus1? a) (double-plus1? b)) (double-plus1 (binplus ( double(binmult (op a) (op b))) (binplus (op a) (op b))))]
    ...
    [(and (double? a) (double-plus1? b)) (double(binplus(double(binmult (op a) (op b))) (op a)))]
    )
